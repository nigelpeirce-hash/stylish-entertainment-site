...
const services = [
  ...
  },
  {
    ...
    alt: "Professional wedding equipment hire across the West Country",
  },
  {
    title: "Fire Pit Hire",
    icon: Zap,
...
export default function Services() {
  useEffect(() => {
    document.title = "West Country Wedding Services | Lighting Design & Venue Styling";
    const metaDescription = document.querySelector('meta[name="description"]');
    if (metaDescription) {
      metaDescription.setAttribute("content", "Professional wedding lighting design and venue styling services across the West Country including London, Somerset, Bath, Bristol, Dorset, and Devon. Transform your wedding venue with our expert team.");
    }
  }, []);
