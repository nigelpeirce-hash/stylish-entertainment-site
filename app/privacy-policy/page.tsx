...
export default function PrivacyPolicy() {
  useEffect(() => {
    document.title = "Privacy Policy | Stylish Entertainment";
    const metaDescription = document.querySelector('meta[name="description"]');
    if (metaDescription) {
      metaDescription.setAttribute("content", "Privacy Policy for Stylish Entertainment. Learn how we collect, use, and protect your personal data in accordance with GDPR and UK data protection laws.");
    }
  }, []);
  ...
  return (
    <div>
      {/* Content */}
      <section className="py-20 px-4 bg-gray-800 pt-32 md:pt-40">
            ...
            <Card className="bg-gray-900 border-champagne-gold/30">
              <CardContent className="p-6 sm:p-8 md:p-12">
                <div className="text-center mb-8">
                  <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-sans mb-4 sm:mb-6 text-white font-bold">
                    Privacy Policy
                  </h1>
                ...
                <div className="text-gray-300 leading-relaxed space-y-6 prose prose-invert max-w-none">
                  <p>
                  ...
                  <div className="my-8">
                    <h2 className="text-2xl md:text-3xl font-bold text-champagne-gold mb-4">Information we may collect from you</h2>
                    <p className="mb-4">We may collect and process the following information about you:</p>

                    <h3 className="text-xl md:text-2xl font-bold text-champagne-gold mb-3 mt-6">Information you give us</h3>
                    <p className="mb-4">
                    ...
                    <h3 className="text-xl md:text-2xl font-bold text-champagne-gold mb-3 mt-6">Information we collect about you</h3>
                    ...
                    <h3 className="text-xl md:text-2xl font-bold text-champagne-gold mb-3 mt-6">Information we receive from other sources</h3>
                    <p>
                  ...
                  <div className="my-8">
                    <h2 className="text-2xl md:text-3xl font-bold text-champagne-gold mb-4">Cookies</h2>
                    <p>
                  ...
                  <div className="my-8">
                    <h2 className="text-2xl md:text-3xl font-bold text-champagne-gold mb-4">Uses made of the information</h2>
                    <p className="mb-4">We use information held about you in the following ways:</p>

                    <h3 className="text-xl md:text-2xl font-bold text-champagne-gold mb-3 mt-6">Information you give to us</h3>
                  ...
                  <div className="my-8">
                    <h2 className="text-2xl md:text-3xl font-bold text-champagne-gold mb-4">Disclosure of your information</h2>

                    <h3 className="text-xl md:text-2xl font-bold text-champagne-gold mb-3 mt-6">Information we share with third parties</h3>
                    ...
                    <h3 className="text-xl md:text-2xl font-bold text-champagne-gold mb-3 mt-6">Information we disclose to third parties</h3>
                  ...
                  <div className="my-8">
                    <h2 className="text-2xl md:text-3xl font-bold text-champagne-gold mb-4">Where we store your personal data</h2>
                    <p className="mb-4">
                  ...
                  <div className="my-8">
                    <h2 className="text-2xl md:text-3xl font-bold text-champagne-gold mb-4">Protection of Information</h2>
                    <p className="mb-4">
                  ...
                  <div className="my-8">
                    <h2 className="text-2xl md:text-3xl font-bold text-champagne-gold mb-4">Links to other websites</h2>
                    <p>
                  ...
                  <div className="my-8">
                    <h2 className="text-2xl md:text-3xl font-bold text-champagne-gold mb-4">Your rights</h2>
                  ...
                  <div className="my-8">
                    <h2 className="text-2xl md:text-3xl font-bold text-champagne-gold mb-4">Consent</h2>
                    <p className="mb-4">
                  ...
                  <div className="my-8">
                    <h2 className="text-2xl md:text-3xl font-bold text-champagne-gold mb-4">Data Retention</h2>
                    <p className="mb-4">
                  ...
                  <div className="my-8">
                    <h2 className="text-2xl md:text-3xl font-bold text-champagne-gold mb-4">Age of Users</h2>
                    <p>
                  ...
                  <div className="my-8">
                    <h2 className="text-2xl md:text-3xl font-bold text-champagne-gold mb-4">Complaints or queries</h2>
                    <p className="mb-4">
                  ...
                  <div className="my-8">
                    <h2 className="text-2xl md:text-3xl font-bold text-champagne-gold mb-4">Changes to this privacy policy</h2>
                    <p>
                  ...
                  <div className="my-8 p-6 bg-gray-800/50 rounded-lg border border-champagne-gold/20">
                    <h2 className="text-2xl md:text-3xl font-bold text-champagne-gold mb-4">How to contact us</h2>
                    <p className="mb-4">
                      Questions, comments and requests regarding this Privacy Policy are welcomed and should be addressed to:
                    </p>
                    <p className="mb-2">
                      <strong>Email:</strong>{" "}
                      <a href="mailto:info@stylishentertainment.co.uk" className="text-champagne-gold hover:text-gold-light underline">
