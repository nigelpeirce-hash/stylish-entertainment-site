...
// SEO location data – accordion at bottom. Order: West Country first.
const SERVICE_AREAS_ORDER = ["Somerset", "Wiltshire", "Gloucestershire", "Bath", "Bristol", "Dorset", "Devon"];
...
export default function PrivatePartiesDemoClient() {
  ...
  return (
    <div className="min-h-screen bg-gray-950 text-white">
      ...
      <div className="bg-champagne-gold/20 border-b border-champagne-gold/40 py-2 px-4 text-center text-sm text-champagne-gold">
        <span className="font-medium">Refactor demo</span>
        {" · "}
        <Link href="/parties/private-parties/" className="underline hover:no-underline">
          View current page
        </Link>
      </div>
