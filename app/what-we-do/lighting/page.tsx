...
export default function Lighting() {
  useEffect(() => {
    document.title = "Lighting | Professional Event Lighting Design | Stylish Entertainment";
    const metaDescription = document.querySelector('meta[name="description"]');
    if (metaDescription) {
      metaDescription.setAttribute("content", "Transform your venue with bespoke lighting design. LED uplighting, intelligent moving lights, atmospheric mood lighting, and dance floor packages across the West Country.");
    }
  }, []);
  ...
  return (
    <div>
      ...
      <section className="relative min-h-[60vh] flex items-center justify-center bg-gray-900 text-white overflow-hidden">
        ...
        >
          <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-sans mb-4 sm:mb-6 text-white font-bold px-4 drop-shadow-lg">Lighting</h1>
          ...
          <Card className="bg-gray-800 border-champagne-gold/30">
            <CardHeader>
              ...
              <CardDescription className="text-lg text-gray-300">
                Create the perfect ambiance for your special day with our bespoke lighting design service. From subtle mood lighting to dramatic dance floor effects, we transform your venue into a magical space that enhances every moment of your celebration.
              </CardDescription>
            </CardHeader>
              ...
              <div>
                ...
                <ul className="space-y-3">
                  {[
                    ...
                    "Mirror balls and disco lighting",
                    "Festoon and string lighting",
                  ].map((feature, idx) => (
