      ...
      <Card className="bg-gray-800/50 backdrop-blur-md border-2 border-champagne-gold/50">
        ...
        <CardContent className="space-y-4">
          <div className="space-y-2">
            <Label className="text-white">Musician Name *</Label>
            <Input
              value={formData.name}
          ...
          <div className="space-y-2">
            <Label className="text-white">Instrument / Specialization</Label>
            <Input
              value={formData.instrument}
              onChange={(e) =>
                onFormDataChange({ ...formData, instrument: e.target.value })
              }
              placeholder="e.g., Harpist, Saxophonist, Pianist"
              className="bg-gray-900/50 text-white border-gray-700 focus:border-champagne-gold"
            />
          </div>
          ...
          <div className="space-y-2">
            ...
            <Input
              ...
              placeholder="e.g., Sarah Johnson | Professional Harpist"
              className="bg-gray-900/50 text-white border-gray-700 focus:border-champagne-gold"
            />
          </div>
