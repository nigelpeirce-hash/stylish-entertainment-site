...
// This is a client component - no export const dynamic here
...
export default function ProfessionalDJBlogContent() {
  useEffect(() => {
    document.title = "Why You Should Use an Experienced, Professional DJ | Stylish Entertainment";
