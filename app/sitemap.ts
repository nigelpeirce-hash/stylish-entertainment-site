...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  ...
  const staticPages: MetadataRoute.Sitemap = [
    ...
    url('/about/journal/10-things-weve-learned-from-hundreds-of-babington-house-weddings', 'monthly', 0.8),
    ...
    url('/wedding-dj-somerset', 'monthly', 0.82),
    url('/wedding-dj-bath', 'monthly', 0.82),
    url('/wedding-dj-bristol', 'monthly', 0.82),
    url('/wedding-dj-london-home-counties', 'monthly', 0.85),
    url('/luxury-wedding-entertainment-south-west', 'monthly', 0.85),
    url('/wedding-production-london', 'monthly', 0.85),
